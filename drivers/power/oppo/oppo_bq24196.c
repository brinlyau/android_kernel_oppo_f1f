...
int bq24196_chg_uv(struct opchg_charger *chip, u8 status)
{
	...
	*****************************************/
	if(is_project(OPPO_15035)|| (is_project(OPPO_15109) && (get_PCB_Version() == HW_VERSION__10||get_PCB_Version() == HW_VERSION__12||get_PCB_Version() == HW_VERSION__14||get_PCB_Version() == HW_VERSION__15)))
	{
