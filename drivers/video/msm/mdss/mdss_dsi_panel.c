...
/* wuyu@EXP.BaseDrv.LCM, 2015-05-18, add micro OPPO_15011, (OPPO15011=OPPO_15018) */
/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
	if(MSM_BOOT_MODE__NORMAL!=get_boot_mode() && (is_project(OPPO_15011) || is_project(OPPO_15018) || is_project(OPPO_15022) || is_project(OPPO_15085) || is_project(OPPO_15109))){
		pinfo->esd_check_enabled = false;
	}
#endif /*VENDOR_EDIT*/
...
//lile@EXP.BasicDrv.LCD, 2016-01-04, add reset cmds for Tianma HD LCD ESD blurred
	...
	if (!rc) {
		if (!strcmp(data, "bta_check")) {
			...
			(lcd_dev == LCD_15035_TRULY_HX8389C) || is_project(OPPO_15109)){
